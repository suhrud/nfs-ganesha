...
FILE(APPEND ${RPM_ROOTDIR}/SPECS/${RPMNAME}.spec  "mkdir -p $RPM_BUILD_ROOT${_initdir}")
...
if("${DISTRO}" STREQUAL "redhat")
FILE(APPEND ${RPM_ROOTDIR}/SPECS/${RPMNAME}.spec  "
install -m 644 ganesha.init                              $RPM_BUILD_ROOT${_initdir}/nfs-ganesha")
endif("${DISTRO}" STREQUAL "redhat")
